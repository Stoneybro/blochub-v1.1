...
const Services = () => {
  return (
    <div className="bg-black pt-28 pb-16  text-white" data-scroll-section id='services'>
   ...
   <div className="flex flex-col lg:justify-center relative h-[18rem] lg:w-[850px] z-[0] lg:gap-4">
        ...
        <div className="lg:text-[1.6rem] text-[1.3rem] font-light leading-6 lg:leading-8 ml-20 lg:mt-0 lg:ml-[25rem] lg:-mr-32 "><div className="break-all w-full lg:break-keep max-w-[30rem]">Experience the true spirit of collaboration at Blochub, where blockchain enthusiasts and developers unite to create groundbreaking innovations together.</div>
        </div>
        </div>
    </div>    
   <div className="">
